...
<span id="endnote-3">3.</span><br>1) 如果你是 Windows 8/8.1/10/11 的用户，系统已自带高版本的 .NET Framework，无需额外操作；<br>2) 如果你是 Windows 7 或 XP 的用户，请打开 SMWP v1.6 压缩包中自带的 `dotNetFx40_Full_setup.exe` 进行安装。安装过程需要连接网络。
