...
#### Copying a Region
- After selecting the desired area (simply keep the selection active; there is no need to enter move mode), press `Ctrl + C` (the copy key, which can be customized in the settings).
